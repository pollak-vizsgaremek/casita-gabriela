...
INSERT DELAYED IGNORE INTO `booking` (`id`, `arrival_date`, `departure_date`, `people`, `booking_date`, `status`, `user_id`, `room_id`, `total_price`) VALUES
...
INSERT DELAYED IGNORE INTO `category` (`id`, `name`, `image`) VALUES
...
INSERT DELAYED IGNORE INTO `form` (`id`, `name`, `email`, `phone_number`, `topic`, `description`, `created_at`) VALUES
...
INSERT DELAYED IGNORE INTO `room` (`id`, `name`, `description`, `price`, `ac_availablity`, `category`, `space`, `images`, `isHighlighted`) VALUES
...
INSERT DELAYED IGNORE INTO `room_review` (`id`, `stars`, `comment`, `room_id`, `user_id`) VALUES
...
INSERT DELAYED IGNORE INTO `users` (`id`, `name`, `password`, `phone_number`, `birth_date`, `address`, `identity_card`, `email`, `isAdmin`, `isFirstTimeUser`) VALUES
...
INSERT DELAYED IGNORE INTO `_prisma_migrations` (`id`, `checksum`, `finished_at`, `migration_name`, `logs`, `rolled_back_at`, `started_at`, `applied_steps_count`) VALUES
