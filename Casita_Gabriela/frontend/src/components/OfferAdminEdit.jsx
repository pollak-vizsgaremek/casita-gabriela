...
const OfferAdminEdit = ({ id, name, price, image }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className='bg-white hover:cursor-pointer hover:rotate-1 transition-all duration-300 fade-in shadow-md hover:shadow-2xl active:shadow-green-500 rounded-xl w-72 h-72 flex flex-col items-center'
    >
