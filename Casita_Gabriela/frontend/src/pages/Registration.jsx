...
const Registration = () => {
	...
	const handleChange = (e) => {
		...
		// Telefonszám: max 12 karakter, amit a felhasználó beír - betűk nincsenek engedélyezve
		if (name === "phone_number") {
			const noLetters = value.replace(/\p{L}/gu, "");
			const cleaned = noLetters.slice(0, 12);
